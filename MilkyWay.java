...
public class MilkyWay extends AbstractSimulation {
	...
	// double axMoon = 0;
	// double ayMoon = 0;
	// double xpositionMoon = 1.5004E11;
	// double ypositionMoon = 0;
	// Trail MoonOrbit = new Trail();
	...
	public void initialize() {
		...
		// earth moon sun d.setPreferredMinMax(-1.7E11, 1.7E11, -1.7E11, 1.7E11);
		d.setVisible(true);
	...
	public static void main(String[] args) {
		SimulationControl.createApp(new MilkyWay());
	}
