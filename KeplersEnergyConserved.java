...
public class KeplersEnergyConserved extends AbstractSimulation {
	...
	double axEarth = 0;
	double ayEarth = 0;
	double xpositionEarth = (1.5 * Math.pow(10, 11)) - Math.pow(10, 10) * 5;
	...
	PlotFrame VXGraph = new PlotFrame("Velocity", "Position", "V vx X Graph");
	double KE = 0;
	double PE = 0;
	double KEsun = 0;
...
//
//			// System.out.println(Math.pow(distance(0, 0, SS.get(0).getVx(),
//			// SS.get(0).getVy()), 2));
//
//			EnergyGraph.append(xpcounter, counter, ((KE + KEsun + PE)));
			VXGraph.append(xpcounter, counter, distance(0, 0, SS.get(1).getVx(), SS.get(1).getVy()));
//			// EnergyGraph.setMarkerColor(xpcounter, Color.green, Color.green);

			// System.out.println("KE: " + KE + " PE: " + PE + " Total: " + (KE + PE));
			// System.out.println((KE + KEsun + PE) + " " + Math.round((KE + KEsun + PE)));
			// if (xpcounter == 4) {
			// System.out.println("KE: " + KE + " PE: " + PE + " Total: " + (KE + PE));
			// }
			...
			KE = 0.5 * SS.get(1).getM() * Math.pow(distance(0, 0, SS.get(1).getVx(), SS.get(1).getVy()), 2);
			PE = -(G * SS.get(1).getM() * SS.get(0).getM()) / distance(SS.get(0).getXposition(), SS.get(0).getYposition(),
					SS.get(1).getXposition(), SS.get(1).getYposition());
			KEsun = 0.5 * SS.get(0).getM() * Math.pow(distance(0, 0, SS.get(0).getVx(), SS.get(0).getVy()), 2);
			if (ecount > 0) {
	...
	public static void main(String[] args) {
		SimulationControl.createApp(new KeplersEnergyConserved());
	}
